...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create GUI text box for answer and question
        self.magicQuestionText = QLabel(self.magicQuestion)
        self.magicAnswerText = QLabel(self.magicAnswer)
        # Center align GUI text box for answer and question
        ...
        # Add all text box/button as widgets
    ...
    def responding(self, response):
        # Change text box to show answer
